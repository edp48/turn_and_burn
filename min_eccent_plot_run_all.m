...
[opt_initial_vec1(:,j),fval,exitflag,output]= fminsearch(@(guess_init) cost_function_matlab(guess_init,p,funs),guess_init,options);

guess_init = opt_initial_vec1(:,j);
...
[opt_initial_vec2(:,1),fval,exitflag,output]= fminsearch(@(guess_init) cost_function_matlab(guess_init,p,funs),guess_init,options);
...
[opt_initial_vec2(:,j),fval,exitflag,output]= fminsearch(@(guess_init) cost_function_matlab(guess_init,p,funs),guess_init,options);

guess_init = opt_initial_vec2(:,j);
