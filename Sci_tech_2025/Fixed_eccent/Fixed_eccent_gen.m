...
if savefig
    print(gcf, 'fixed_TOF', '-depsc', '-r300');
    print(gcf, 'fixed_TOF', '-dsvg');
end
...
if savefig
    print(gcf, 'fixed_Prop_Mass', '-depsc', '-r300');
    print(gcf, 'fixed_Prop_Mass', '-dsvg');
end 
...
if savefig
    print(gcf, 'fixed_dV', '-depsc', '-r300');
    print(gcf, 'fixed_dV', '-dsvg');
end
...
if savefig
    print(gcf, 'fixed_flip_time', '-depsc', '-r300');
    print(gcf, 'fixed_flip_time', '-dsvg');
end 
...
if savefig
    print(gcf, 'fixed_eccent', '-depsc', '-r300');
    print(gcf, 'fixed_eccent', '-dsvg');
end
...
if savefig
    print(gcf, 'fixed_Bounded_Trajectories', '-depsc', '-r300');
    print(gcf, 'fixed_Bounded_Trajectories', '-dsvg');
end 
