...
problem.options.chebyshev.nColPts = 20;
...
save("out1.mat","Mdot_Master","Z_Master","TOF_Master","Time_Master","Thrust_Master","Lambert_Master","Control_Master","p","master","nsims")
...
figure(3)
plot(Thrust_Master,TOF_Master);
title("TOF","Interpreter","latex","FontSize",18)

figure(4)

hold on
plot(Thrust_Master,dv,"DisplayName","Cont. Thrust")
plot(Thrust_Master,Lambert_Master,"DisplayName","Lambert")
legend
title("$\Delta V$ Values","Interpreter","latex","FontSize",18)

figure(5)
plot(Thrust_Master,turn./TOF_Master.')
title("flip time (perc)","Interpreter","latex","FontSize",18)
